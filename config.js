...
(function(){
  ...
  function loadOnce(file){
    ...
    const s=document.createElement('script');s.src=file+'?v=20260901-stable8';s.dataset.pepmosaStable=file;document.body.appendChild(s);
  }
  function boot(){
    ...
    if(isAdmin){
      if(!document.querySelector('script[data-pepmosa-stable="admin-repair.js"]'))document.write('<script src="admin-repair.js?v=20260901-stable8" data-pepmosa-stable="admin-repair.js"></'+'script>');
      loadOnce('admin-gb-categories.js');
    }
    if(isStorefront){loadOnce('storefront-repair.js');loadOnce('fee-modal-repair.js');}
  }
  boot();
})();
