...
/* Clean order-success dialog */
#pepInfoModal{z-index:999998!important;background:rgba(48,25,42,.34)!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}
...
#pepInfoModal>div{width:min(500px,calc(100vw - 36px))!important;border:1px solid rgba(216,55,143,.16)!important;border-radius:28px!important;background:linear-gradient(145deg,#fff,#fff8fc)!important;box-shadow:0 24px 60px rgba(67,28,54,.20)!important;padding:32px 28px 28px!important;text-align:center}
#pepInfoModal #pepInfoTitle{font-size:30px!important;line-height:1.1!important;letter-spacing:-.7px!important;margin:0 0 10px!important}
#pepInfoModal #pepInfoText{font-size:13px!important;line-height:1.6!important;color:#7b6973!important;max-width:390px!important;margin:0 auto 24px!important}
#pepInfoModal #pepInfoOk{min-width:150px!important;min-height:48px!important;border:0!important;border-radius:15px!important;background:linear-gradient(135deg,#e62b89,#b844bd)!important;color:#fff!important;font-weight:900!important;box-shadow:0 10px 24px rgba(207,44,133,.18)!important}
@media(max-width:520px){#pepInfoModal>div{padding:28px 20px 23px!important}#pepInfoModal #pepInfoTitle{font-size:26px!important}}@media(max-width:700px){.pepFinalBody{padding:17px 18px 23px}.pepFinalHead{padding:24px 20px 20px}.pepFinalHead h2{font-size:29px}.pepPaymentGrid{grid-template-columns:1fr 1fr}.pepQRWrap{grid-template-columns:1fr;text-align:center}.pepQRWrap img{margin:auto;width:210px;height:210px}.pepQRText{text-align:left}.pepFields{grid-template-columns:1fr}.pepField.full{grid-column:auto}.pepFinalActions{flex-direction:column}.pepCancel{order:2}}`;document.head.appendChild(s)}
